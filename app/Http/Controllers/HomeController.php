...
//            }
//        }
//        $others_db = DB::table('news')->select('id', 'category_id', 'name', 'url', 'title', 'image')->leftJoin('news_category', 'category_id', 'id')->where('new_of_category', 1)->where('publish', 1)->whereIn('category_id', $category)->orderBy('id', 'desc')->get();
